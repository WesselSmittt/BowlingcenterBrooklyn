<x-app-layout>
    ...
    <div class="flex justify-center items-center mb-4">
        <form method="GET" action="{{ route('Wessel.index') }}">
            <input type="date" name="vanaf_datum" value="{{ request('vanaf_datum') }}">
            <button type="submit">Tonen</button>
        </form>
        <a href="{{ route('Wessel.index') }}" class="ml-4 px-2 py-1 bg-red-500 text-white rounded-md hover:bg-red-600 text-xl">Clear</a>
        ...
        <tbody class="bg-white divide-y divide-gray-200">
            ...
            <tr>
                ...
                <td class="px-6 py-4 whitespace-nowrap text-left text-sm font-medium">
                    <a href="{{ route('Wessel.edit', $reservering->id) }}" class="text-indigo-600 hover:text-indigo-900">✏️</a>
                </td>
            </tr>
            @endforeach
